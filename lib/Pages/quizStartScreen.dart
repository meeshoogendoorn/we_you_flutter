...
import 'package:survey_app/Pages/questionScreen.dart';

class QuizStartScreen extends StatefulWidget {
  final int quizID;

  QuizStartScreen({Key key, @required this.quizID}) : super(key: key);
  @override
  _QuizStartScreenState createState() => _QuizStartScreenState(quizID);
}
...
class _QuizStartScreenState extends State<QuizStartScreen>
  ...
  int quizID;
  _QuizStartScreenState(this.quizID);
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text(
                                  quizRound[quizID]["questions"].toString() + " Vragen",
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                ...
                                Container(
                                  child: Row(
                                    children: <Widget>[
                                      Text(
                                        quizRound[quizID]["percentage"].toString(),
                                        textAlign: TextAlign.left,
                                        style: TextStyle(
                                          fontWeight: FontWeight.w200,
                                          fontSize: 22,
                          ...
                          AnimatedOpacity(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  getTimeBoxUI(quizRound[quizID]["multiple_choice"].toString(), "Meerkeuze"),
                                  getTimeBoxUI(quizRound[quizID]["open"].toString(), "Open"),
                                ],
                              ),
                            ),
                          ),
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: (){ Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => QuestionScreen(quizID: quizID, quizRoundNum: 0,),
                                        ),
                                      ); },
                                      child: Container(
                                        height: 48,
